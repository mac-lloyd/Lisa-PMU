...
class Parametres:
    ...
    def __init__(self):
        ...
        self.max_cov_etat = np.array([2,2,0.5]) * self.dt
        self.min_cov_etat = np.array([0.2,0.2,0.1]) * self.dt
        self.duree_dec_cov_etat = 60 * self.Hz
        self.sigma_dec_cov_etat = self.duree_dec_cov_etat / 2

        self.max_cov_v = 0.1
        self.min_cov_v = 0.03
        self.max_cov_mode = [100, 6, 3, 1, 0.03, 0.5]
        self.min_cov_mode = [100, 2, 0.8, 1, 0.03, 0.5]
