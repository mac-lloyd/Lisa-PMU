...
class Parametres:
    ...
    def __init__(self):
        ...
        self.cov_mode_pos = np.square([100, 3, 1.5, 1, 0.03, 0.5]) # [100, 2, 0.8, 1, 0.03, 0.2]) #
        self.cov_mode_v = np.square(np.float(0.1) / np.float(3.6))
            ...
            if etats_capteurs[k] > 0:
                ...
                if calculer_position and MODE == "course" and etats_capteurs[k] == 2 and not (
                    ...
                    if self.Mes.depart_franchis[k] and (not self.Ind.arrive[k]) and (not first_dep):
                        ...
                        Mat_etat, cov_obs, cov_etat, prev_etat, prev_P = recherche_prediction(self.Mes,
                                                                                              k,
                                                                                              trame)
                                ...
                                try:
                                    ...
                                    if msg.startswith("PathParcours:"):
                                        ...
                                        try:
                                            ...
                                            liste_id = [15,16,28,32,33,37,31,40] #[11,12,13,14,18,21,22,29,39] #[13,18,21,22,23,26,29,34,35] # [16,19,20,31,32,33,37,40] #### TEST
                                            print "liste id"
                                            print liste_id
