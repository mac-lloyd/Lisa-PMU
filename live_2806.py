            ...
            if STATE_UDP:
                ...
                try:
                    ...
                    while STATE_UDP and connected:
                        ...
                        if np.size(frames) > 0:
                            if np.size(frames) == par.size_trame:
                        ...
                        with open('data_brute' + str(t_start) + '.csv', 'a') as csvfile:
                            spamwriter = csv.writer(csvfile, delimiter=';')
                            spamwriter.writerow([num_analyse, time.time()])
                        ...
                        for k in range(0, nb_id):
                            ...
                            if etats_capteurs[k] > 0:
                                ...
                                if trame_recue:
                                    Mes.count_persistence[k] = 0
                                else:
                                    Mes.count_persistence[k] = Mes.count_persistence[k] + 1
                                ...
                                if calculer_position and MODE == "course" and etats_capteurs[k] == 2 and not (
                                    ...
                                    if Mes.depart_franchis[k] and (not Ind.arrive[k]) and (not first_dep):
                        ...
                        for k in range(0, nb_id):
                            ...
                            elif Mes.count_persistence[k] > par.seuil_persistence:
                                dict_indicateur = format_sortie_rien(k)
